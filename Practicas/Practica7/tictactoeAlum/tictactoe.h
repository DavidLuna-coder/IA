...
} tJugada;   // POR SIMPLIFICAR NO SE USARÁ AQUÍ, PERO ES NECESARIO EN OTROS JUEGOS
...
// Le pasa el turno al jugador opuesto
int opuesto( int jugador);

//devuelve 1 si no quedan casillas libres y 0 si sí
int lleno(tNodo *s);
